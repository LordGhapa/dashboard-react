...
const Notification = () => {
  ...
  return (
    <div className="absolute top-11 sm:right-40 right-1 w-320 p-2 flex flex-col rounded-md bg-white dark:bg-secondary-dark-bg dark:text-white z-10 ">
      ...
      <Button
        ...
        text="Ver todas as notificaçoes"
        borderRadius="10px"
        width="full"
      />
    </div>
